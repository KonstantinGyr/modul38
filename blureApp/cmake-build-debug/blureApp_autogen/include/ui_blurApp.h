/********************************************************************************
** Form generated from reading UI file 'blurApp.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(horizontalSlider, SIGNAL(sliderMoved(int)), MainWindow, SLOT(slider()));
        QObject::connect(pushButton, SIGNAL(clicked()), MainWindow, SLOT(open()));
